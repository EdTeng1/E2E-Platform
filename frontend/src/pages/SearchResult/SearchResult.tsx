		...
		<Card
			...
			cover={
				<img
					alt='example'
					height={350}
					src='https://img2.baidu.com/it/u=3195485747,1001404537&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=667'
				/>
			}
			key={1}>
		...
		<Card
			...
			cover={
				<img
					alt='example'
					height={350}
					src='https://hbimg.b0.upaiyun.com/dc02ea94091c77f8cbcf0efd08440e7d8dd86d9d1c677-FKu2Xo_fw658'
				/>
			}
			key={2}>
		...
		<Card
			...
			cover={
				<img
					alt='example'
					height={350}
					src='https://media.istockphoto.com/photos/portrait-of-confident-young-man-picture-id641272408?k=6&m=641272408&s=170667a&w=0&h=tOWpY7hIKGh-ZYHR7MTgawCxYzD-7pyX2kIzJgrKVQA='
				/>
			}
			key={3}>
		...
		<Card
			...
			cover={
				<img
					alt='example'
					height={350}
					src='https://t12.baidu.com/it/u=177421646,526791588&fm=170&s=CDCCA044CC025955492C0DB203008093&w=600&h=709&img.JPEG'
				/>
			}
			key={4}>
		...
		<Card
			...
			cover={
				<img
					alt='example'
					height={350}
					src='https://5b0988e595225.cdn.sohucs.com/images/20170919/78480444e9e84d0c8ceb491e5bb765cf.jpeg'
				/>
			}
			key={5}>
		...
		<Card
			...
			cover={
				<img
					alt='example'
					height={350}
					src='https://www.qubaobei.com/uploadnew/weekend/2018/7/6/19/1530875097788.png'
				/>
			}
			key={6}>
