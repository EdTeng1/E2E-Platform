		...
		const fetchProfile = async () => {
			try {
				...
				const mappedProfile: Profile = {
					id: profileId ?? "",
					imageUrl:
						"https://images.pexels.com/photos/45201/kitty-cat-kitten-pet-45201.jpeg?cs=srgb&dl=pexels-pixabay-45201.jpg&fm=jpg&_gl=1*13kff3c*_ga*MTcyODI3MDk5My4xNzEyNzQxODk0*_ga_8JE65Q40S6*MTcxMjc0MTg5My4xLjEuMTcxMjc0MTg5OC4wLjAuMA..", // Placeholder value for now
							...
							<Card
								...
								{profile.history.map((engagement, index) => (
									<Card key={index} className='engagement-card' bordered={false}>
										<Typography.Title level={5} className='engagement-title'>
											Engagement {index + 1}
										</Typography.Title>
										<ul className='engagement-details'>
											...
											<li>
												...
												<Typography.Text
													editable={{
														onChange: (newText) =>
															handleHistoryChange(index, "notes", newText),
													}}>
								...
								<Card className='New-Engagement'>
									<Form onFinish={handleAddEngagement} layout='vertical'>
										...
										<Form.Item
											...
											name='engagementA'
											rules={[
												{ required: true, message: "Please select your engagement type!" },
											]}>
										...
										<Form.Item
											...
											rules={[
												{
													required: true,
													message: "Please select your follow-up engagement type!",
												},
											]}>
										...
										<Form.Item label='Information Requested' name='informationRequested'>
